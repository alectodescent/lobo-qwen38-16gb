...
static bool ggml_backend_cuda_kvarn_capabilities(
    ...
    *result = {
        ...
        /* .record_layout                    = */ uint32_t(info.devices[device].cc == GGML_CUDA_CC_BLACKWELL ?
            GGML_BACKEND_KVARN_RECORD_LAYOUT_TILE_16 : GGML_BACKEND_KVARN_RECORD_LAYOUT_ROW_MAJOR),
